...
/**
 * Servlet implementation class CreateSalary
 */
		...
		else
		{
			try
			{
				...
				Connection con=ConnectionPro.getConnection();
			     String query = "INSERT INTO `salary`( `emp_id`, `basic_salary`, `epf_etf`, `allowance`, `ot_per_hour`) VALUES ("+user+","+basic+","+epf+","+all+","+ot+")";
